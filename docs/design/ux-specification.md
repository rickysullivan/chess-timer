...
- Use Direction B as the baseline layout from the HTML showcase and `docs/design/mockups/option-B.png`.
...
- Reference mockup: `docs/design/mockups/option-B.png` and the direction set in `docs/design/ux-specification.md`.
