...
inputDocuments:
  ...
  - docs/design/ux-flows/notes.md
  - docs/design/ux-flows/tournament-traveler.md
  - docs/design/ux-flows/club-organizer.md
  - docs/design/ux-flows/casual-duo.md
...
- Complete `docs/engineering/setup-checklist.md` before implementation work begins.
