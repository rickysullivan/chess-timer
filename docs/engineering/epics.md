...
Engineering setup tasks are tracked in `docs/engineering/setup-checklist.md`.
...
Prerequisite setup tasks (starter init, CI/CD, env, Node baseline, shadcn/Tailwind) are tracked in `docs/engineering/setup-checklist.md` and are not user stories.
